#pragma checksum "C:\项目\AccessManagementSystem\AccessManagement\AccessManagement\Views\AppMenu\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3e911636f28376f91dcfd93a0e8223201dcc8758"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3e911636f28376f91dcfd93a0e8223201dcc8758", @"/Views/AppMenu/Index.cshtml")]
...
");
            EndContext();
            BeginContext(3244, 193, true);
            WriteLiteral("</script>\r\n<script type=\"text/html\" id=\"menubar\">\r\n    <div class=\"layui-table-tool-temp\">\r\n        <div class=\"layui-inline\" lay-event=\"add\"><i class=\"layui-icon layui-icon-add-1\"></i></div>\r\n");
            EndContext();
            BeginContext(3544, 6199, true);
    ...
    layui.use('table', function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[ //表头
                ...
                , { f");
            WriteLiteral(@"ield: 'route', title: 'Route',  }
        ...
        table.on('tool(appmenu)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter=""对应的值""
            ...
            if (layEvent === 'detail') { //查看
                ...
                //do something
                window.location.href = ""/AppMenu/Edit/"" + obj.d");
            WriteLiteral(@"ata.id;
                //同步更新缓存对应的值
                //obj.update({
                //    username: '123'
        ...
        table.on('toolbar(appmenu)', function (obj) {
            ...
            switch (obj.event) {
               ...
               ");
            WriteLiteral(@"         console.log(checkStatus.data.length) //获取选中行数量，可作为是否有选中行的条件
        ...
        table.on('sort(appmenu)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter=""对应的值""
            ...
            //有些时候，你可能需要根据当前排序的字段，重新");
            WriteLiteral(@"向服务端发送请求，从而实现服务端排序，如：
            tableIns.reload({
