#pragma checksum "C:\项目\AccessManagementSystem\AccessManagement\AccessManagement\Views\Account\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "47816c7b71c04f9c90ca41b92e41dc23d0c56a39"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"47816c7b71c04f9c90ca41b92e41dc23d0c56a39", @"/Views/Account/Index.cshtml")]
...
#line default
#line hidden
            BeginContext(110, 448, true);
            WriteLiteral(@"
<br />
<h2>账号管理</h2>
<br />
<div class=""layui-inline"">
    <label class=""layui-label"">账号</label>&nbsp;
    ...
    layui.use('table', function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[ //表头
                ...
                , { field: 'accountName', title: '账号', sort: true, width: 100}
                , { fiel");
            WriteLiteral(@"d: 'name', title: '名称', sort: true, width: 150  }
                , { field: 'statusName', title: '状态' }
                , { field: 'city', title: '城市', }
                , { field: 'phone', title: '手机号', width: 150 }
                , { field: 'createTimeStr', title: '创建时间', sort: true, width: 250 }
                , { field: 'branchName', title: '所在网点', width: 150  }
            ...
            text: {
                none: '暂无相关数据' //默认：无数据。注：该");
            WriteLiteral(@"属性为 layui 2.2.5 开始新增
            }
            , even: true
            , skin: 'line'
            , autoSort: false
        ...
        table.on('tool(account)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter=""对应的值""
            ...
            if (layEvent === 'detail') { //查看
                //do somehing
                window.location.href = ""/account/Details/"" + obj.data.id;
                ...
                //do something
              ");
            WriteLiteral(@"  window.location.href = ""/account/Edit/"" + obj.data.id;
                //同步更新缓存对应的值
                //obj.update({
                //    username: '123'
                //    , title: 'xxx'
        ...
        table.on('toolbar(account)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'delete':
                    layer.confirm('确定要删除吗', function (index) {
                        var checkStatus = table.checkStatus('account_tb'); //idTest 即为基础参数 id 对应的值

                        console.");
            WriteLiteral(@"log(checkStatus.data) //获取选中行的数据
        ...
        //监听排序事件
        table.on('sort(account)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter=""对应的值""
            ...
            //有些时候，你可能需要根据当前");
            WriteLiteral(@"排序的字段，重新向服务端发送请求，从而实现服务端排序，如：
            tableIns.reload({
        ...
        function Del(ids) {
            var idsStr = ids.join("","");
            $.ajax({
                url: ""/account/DeleteIds?ids="" + idsStr,
                type: ""Get"",
                dataType: ""json"",
                error: function (data) {
                    alert(""删除失败！"");
